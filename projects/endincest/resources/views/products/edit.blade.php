    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
        <form method="POST" action="{{route('products.update',$product->id)}}" enctype="multipart/form-data" id='product_form'>
...
<div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
        ...
        <input type="file" name="image" id="product_image" placeholder="Upload Image" class="form-control" value="{{$product->image }}"/>
...
<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
        ...
        <textarea name="description" form="product_form"  class="form-control" placeholder="Please enter  Description">{{ $product->description }}</textarea>
